...
public class NotificationAdapter extends ArrayAdapter<NotificationLogMessage> implements OnClickListener{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       viewHolder.messageTitle.setText(logMessage.messageTitle);
       viewHolder.dateAndTime.setText(logMessage.dateAndTime);
       viewHolder.messageBody.setText(logMessage.messageBody);
